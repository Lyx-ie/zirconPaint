...
//file explorer implementation adapted from xCENTx on stackoverflow
...
int incorrectFileTypeDialogueBox2() {
    ...
    int msgboxID = MessageBox(
        NULL,
        L"You don't have a valid image selected for the Stamp Tool. Select and image and try again.",
        L"ERROR",
        MB_ICONEXCLAMATION | MB_OK
    );
